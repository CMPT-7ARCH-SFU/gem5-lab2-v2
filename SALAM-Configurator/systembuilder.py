...
def main():
    ...
    shutil.copyfile(LAB_PATH + "/SALAM-Configurator/fs_template.py", CONFIG_Path + "fs_" + fileName + ".py")
            ...
            if listType == "acc_cluster":
                for device in devices:
                    ...
                    if "Accelerator" in device:
                        accs.append(device)
        clusters.append(AccCluster(clusterName, dmas, accs, baseAddress, LAB_PATH, configPath))
