...
def buildmulti_vector1_clstr(options, system, clstr):
	...
	# top Definition
	acc = "top"
	ir = "/localhome/mha157/Desktop/gem5-lab2/benchmarks/multi_vector1/hw/top.ll"
	config = "/localhome/mha157/Desktop/gem5-lab2/benchmarks/multi_vector1/config.yml"
	...
	acc = "multi_vector1"
	ir = "/localhome/mha157/Desktop/gem5-lab2/benchmarks/multi_vector1/hw/multi_vector1.ll"
	config = "/localhome/mha157/Desktop/gem5-lab2/benchmarks/multi_vector1/config.yml"
	...
	# vector2 Definition
	acc = "vector2"
	ir = "/localhome/mha157/Desktop/gem5-lab2/benchmarks/multi_vector1/hw/vector2.ll"
	config = "/localhome/mha157/Desktop/gem5-lab2/benchmarks/multi_vector1/config.yml"
...
def makeHWAcc(args, system):
	...
	system.multi_vector1_clstr = AccCluster()
	buildmulti_vector1_clstr(args, system, system.multi_vector1_clstr)
